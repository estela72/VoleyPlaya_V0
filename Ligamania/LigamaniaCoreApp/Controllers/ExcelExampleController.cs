...
namespace LigamaniaCoreApp.Controllers
{
    public class ExcelExampleController : Controller
    {
        ...
        public ExcelExampleController(IHostingEnvironment hostingEnvironment)
        {
        ...
        /// <summary>
        /// /Home/FileReport
        /// Crea un fichero excel con el formato que se le da en el método 'createExcelPackage' ?????diferencia con InMemoryReport?????
        /// </summary>
        ...
        /// <summary>
        /// An in-memory report
        /// Crea un fichero excel con el formato que se le da en el método 'createExcelPackage'
        /// </summary>
        ...
        /// <summary>
        /// /Home/ReadFile
        /// Lee un excel (si no existe lo crea con el formato 'createExcelPackage'), lo lee y lo carga en una página
        /// </summary>
        ...
        private ExcelPackage createExcelPackage()
        {
            ...
            worksheet.HeaderFooter.OddFooter.InsertPicture(
                new FileInfo(Path.Combine(_hostingEnvironment.WebRootPath, "images", "cabecera_ligamania.jpg")),
