...
{
    public class AlineacionRepository : AlineacionGenericAuditableRepository<AlineacionDTO>, IAlineacionRepository
    {
        public AlineacionRepository(ApplicationDbContext context)
            : base(context)
        {
