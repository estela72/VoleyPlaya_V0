...
{
    public class TemporadaRondaRepository : GenericAuditableRepository<TemporadaRondaDTO>, ITemporadaRondaRepository
    {
        public TemporadaRondaRepository(ApplicationDbContext context) : base(context)
        {
        }
        ...
        public async Task<List<string>> GetEquiposRondaActiva(TemporadaCompeticionDTO temporadaCompeticion)
        {
