...
namespace LigamaniaCoreApp.Data.Migrations
{
    ...
    [Migration("20210817224403_golesExtra")]
    partial class golesExtra
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.TemporadaClasificacionDTO", b =>
                {
                    ...
                    b.Property<int>("GolesExtraContra");

                    b.Property<int>("GolesExtraFavor");
            ...
            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetRolesDTO", b =>
                {
            ...
            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUserClaimsDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("oldAspNetUserClaimsDTO");
                });

            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUserLoginsDTO", b =>
                {
                    b.Property<string>("UserId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("oldAspNetUserLoginsDTO");
                });

            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUserRolesDTO", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUsersDTO", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUserClaimsDTO", b =>
                {
                    b.HasOne("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUsersDTO", "User")
            ...
            modelBuilder.Entity("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetUserRolesDTO", b =>
                {
                    b.HasOne("LigamaniaCoreApp.Data.DataModels.Base.Ligamania.Model.oldUser.oldAspNetRolesDTO", "Role")
